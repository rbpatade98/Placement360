...
>(({ className, defaultValue, value: controlledValue, onValueChange, orientation = "horizontal", ...props }, ref) => {
  ...
  return (
    <TabsContext.Provider value={{ value: activeValue, onValueChange: handleValueChange, orientation }}>
      <div
        ...
        className={cn("flex flex-col", orientation === "vertical" && "flex-row", className)}
        {...props}
      />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        context?.orientation === "vertical" && "flex-col h-auto w-auto items-stretch",
        className
      )}
      {...props}
    />
